            ...
            <div className='w-50'>
                ...
                <div className='d-flex'>
                    {/* <div className="input-group mb-3 w-25 me-2">
                        <span className="input-group-text text-light bg-primary border-primary" id="basic-addon1">Qty</span>
                        <input type="number" onClick={handleInputChange} value={quantity} className="form-control border-primary" aria-describedby="basic-addon1" />
                    </div> */}
